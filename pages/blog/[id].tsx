      ...
      <div className="container m-auto">
        ...
        <div className="pt-[98px] blogContainer m-auto tablet:pt-[50px]">
          <p className="text-white text25">
            ...
            known towards the unknown. It’s not a life of ease, but it is one
            they embrace. <br />
            <br />
            ...
            move from place to place, they get more and more fixated on their
            goal. <br />
            <br />
            ...
            friend, Govinda, stays behind to become his student, while
            Siddhartha — although appreciating what he has learned — decides to
            continue on a more individualistic pursuit. <br />
            <br />
            This pursuit takes him through both space and time: He settles down
            in a city, falls for a woman, and over the years, becomes a
            successful businessman. This, of course, doesn’t fulfill him either,
            so he leaves. His next stop, his final stop, is a small home by a
            river where he lives with a ferryman.
          </p>
        </div>
        ...
        <div className="containerSmall bg-[#0A131A] rounded-[20px] text-center py-[53px] mt-[100px] mb-[100px]">
          ...
          <p className="text25 text-white mb-[25px]">
            How about we have a free 15 min phonecall ($150 value) To see how we
            can help <br /> you boost your brand? Just click the button below
            and lets get stated!
          </p>
          ...
          <div className="grid grid-cols-2 items-center tablet:grid-cols-1">
            ...
            <div>
              <p className="text-white text25 font-normal">
                ...
                the known towards the unknown. It’s not a life of ease, but it
                is one they embrace. <br />
                <br />
                When they are hungry, they fast. When they are unoccupied, they
